...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        ### Forward pass ###
        # TO: Hidden layer - Replace these values with your calculations.
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        output_error_term = error # because the derivative of just x is 1
        # TODO: Calculate the hidden layer's contribution to the error
        hidden_error = self.weights_hidden_to_output.dot(error)
        # TODO: Backpropagated error terms - Replace these values with your calculations.
        hidden_error_term = hidden_error * hidden_outputs * (1 - hidden_outputs) # hidden layer incorporates sigmoid function
